...
folder_path = '/users/nityamadhwal/nltk_data'
data = open(os.path.join("./", "Article_1.json"), "r")
...
# normally wordcloud is applied on list of documents
...
mask = np.array(Image.open("./peacock.png"))
